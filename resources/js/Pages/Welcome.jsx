...
export default function Welcome({
    ...
    featuredImages = [
        "https://migrationpolicycentre.eu/wp-content/uploads/2020/06/school-closures-during-covi19-pandemic.png",
        "https://migrationpolicycentre.eu/wp-content/uploads/2020/06/school-closures-during-covi19-pandemic.png",
        "https://migrationpolicycentre.eu/wp-content/uploads/2020/06/school-closures-during-covi19-pandemic.png",
    ],
}) {
                    ...
                    <div className="max-w-3xl">
                        ...
                        <div className="mt-8 flex gap-4 flex-wrap justify-left">
                            <motion.a
                                ...
                                whileTap={{ scale: 0.98 }}
                                href="#projects"
                                className="inline-flex items-center gap-3 rounded-xl bg-yellow-500 px-5 py-3 text-sm font-medium shadow-lg"
                            >
                            ...
                            <motion.a
                                whileHover={{ scale: 1.02 }}
                                className="inline-flex items-center gap-3 rounded-xl border border-white/20 px-5 py-3 text-sm font-medium text-white"
                                href="#contact"
                            >
                                Contact Us
                            </motion.a>
